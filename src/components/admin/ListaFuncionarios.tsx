...
interface Props {
  ...
  onToggleAtivo: (funcionario: Funcionario) => void
}

export default function ListaFuncionarios({ funcionarios, onEditar, onDeletar, onToggleAtivo }: Props) {
              ...
              <td className="px-4 py-3 text-right">
                <div className="flex justify-end gap-2">
                  ...
                  <Button
                    ...
                    variant="danger"
                    onClick={() => {
                      if (confirm(`Deletar ${f.nome}? Esta ação não pode ser desfeita.`)) {
                        onDeletar(f._id!)
                      }
                    }}
                  >
