...
export async function PUT(
  ...
  try {
    ...
    await criarLog(admin?.username ?? 'sistema', 'editar_leitura_energia', `Leitura de energia editada: ${params.id}`)
...
export async function DELETE(
  ...
  try {
    ...
    await criarLog(admin?.username ?? 'sistema', 'deletar_leitura_energia', `Leitura de energia removida: ${params.id}`)
